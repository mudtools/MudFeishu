...
public class DemoDepartmentEventHandler : DepartmentCreatedEventHandler
{
    ...
    protected override async Task ProcessBusinessLogicAsync(EventData eventData, DepartmentCreatedResult? departmentData, FeishuEventHeader? header, CancellationToken cancellationToken = default)
    {
        if (eventData == null)
