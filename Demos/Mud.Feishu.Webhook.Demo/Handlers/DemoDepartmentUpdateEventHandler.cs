...
public class DemoDepartmentUpdateEventHandler : DepartmentUpdateEventHandler
{
    ...
    protected override async Task ProcessBusinessLogicAsync(EventData eventData, DepartmentUpdateResult? eventEntity, FeishuEventHeader? header, CancellationToken cancellationToken = default)
    {
        if (eventData == null)
