...
public class UserCreatedEventHandler : UserCreateEventHandler
{
    ...
    protected override async Task ProcessBusinessLogicAsync(EventData eventData, UserCreateResult? eventEntity, FeishuEventHeader? header, CancellationToken cancellationToken = default)
    {
        if (eventEntity == null)
        {
...
public class UserUpdatedEventHandler : UserUpdateEventHandler
{
    ...
    protected override async Task ProcessBusinessLogicAsync(EventData eventData, UserUpdateResult? eventEntity, FeishuEventHeader? header, CancellationToken cancellationToken = default)
    {
