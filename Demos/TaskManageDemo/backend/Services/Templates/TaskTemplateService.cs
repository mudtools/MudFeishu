...
public interface ITaskTemplateService
{
    ...
    /// 获取所有模板
    /// </summary>
    Task<List<TaskTemplateDto>> GetAllTemplatesAsync(CancellationToken cancellationToken = default);

    /// <summary>
    /// 获取模板详情
    /// </summary>
    Task<TaskTemplateDto?> GetTemplateByIdAsync(int id, CancellationToken cancellationToken = default);

    /// <summary>
    /// 创建模板
    /// </summary>
    Task<TaskTemplateDto> CreateTemplateAsync(CreateTaskTemplateRequest request, CancellationToken cancellationToken = default);

    /// <summary>
    /// 更新模板
    /// </summary>
    Task<TaskTemplateDto?> UpdateTemplateAsync(int id, UpdateTaskTemplateRequest request, CancellationToken cancellationToken = default);
    ...
    /// 从模板创建任务
    /// </summary>
    Task<TaskDto?> CreateTaskFromTemplateAsync(int templateId, CreateTaskFromTemplateRequest request, CancellationToken cancellationToken = default);
}
...
public class CreateTaskFromTemplateRequest
{
    ...
    /// 截止时间覆盖
    /// </summary>
    public DateTime? DueTimeOverride { get; set; }

    /// <summary>
    /// 负责人覆盖
    /// </summary>
    public List<string>? AssigneeIdsOverride { get; set; }
