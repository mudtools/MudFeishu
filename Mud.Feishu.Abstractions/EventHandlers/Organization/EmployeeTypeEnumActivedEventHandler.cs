...
/// </summary>
public abstract class EmployeeTypeEnumActivedEventHandler : DefaultFeishuEventHandler<EmployeeTypeEnumActivedResult>
{
    /// <summary>
    /// 默认构造函数
    /// </summary>
    /// <param name="logger"></param>
    public EmployeeTypeEnumActivedEventHandler(ILogger logger)
        : base(logger)
    {
    }
    ...
    /// 支持的事件类型
    /// </summary>
    public override string SupportedEventType => FeishuEventTypes.EmployeeTypeEnumActived;
}
