...
public class CreateWebsiteDeliveryByAttachmentRequest
{
    /// <summary>
    /// <para>职位广告 ID</para>
    /// <para>必填：是</para>
    ...
    /// <summary>
    /// <para>简历附件文件 ID，需通过创建附件接口生成</para>
    /// <para>必填：是</para>
    ...
    /// <summary>
    /// <para>电话国家码（与附件中的值不一致时以本参数为准）</para>
    /// <para>必填：否</para>
    /// <para>示例值：CN_1</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>手机号（与附件中的值不一致时以本参数为准）</para>
    /// <para>必填：否</para>
    ...
    /// <summary>
    /// <para>证件信息（与附件中的值不一致时以本参数为准）</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonPropertyName("identification")]
    public WebsiteDeliveryAttachmentIdentification? Identification { get; set; }
}
