...
public class ExternalBackgroundCheck
{
    ...
    /// <summary>
    /// <para>外部系统背调主键（仅用于幂等）：不传则不进行幂等校验；传入后同一 external_id 24 小时内仅可创建一次</para>
    /// <para>必填：否</para>
    /// <para>示例值：123</para>
    /// </summary>
    ...
    public ExternalBackgroundCheckAttachment[]? AttachmentList { get; set; }
}
