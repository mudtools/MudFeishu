...
/// <summary>
/// <para>获取面试满意度问卷列表查询参数（查询对象模式，见 AGENTS.md API-2）</para>
/// </summary>
public class InterviewQuestionnaireListQuery : IQueryParameter
{
    /// <summary>
    ...
    /// <summary>
    /// <para>投递 ID；与 interview_id 不允许同时填写</para>
    /// <para>必填：否</para>
    /// </summary>
    public string? ApplicationId { get; set; }

    /// <summary>
    /// <para>面试 ID；与 application_id 不允许同时填写</para>
    /// <para>必填：否</para>
    /// </summary>
