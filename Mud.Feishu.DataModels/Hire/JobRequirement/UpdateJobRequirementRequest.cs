...
public class UpdateJobRequirementRequest
{
    /// <summary>
    /// <para>需求名称</para>
    /// <para>必填：是</para>
    ...
    /// <summary>
    /// <para>自定义字段（更新时全量覆盖），是否必填以招聘需求模板中自定义字段的定义为准</para>
    /// <para>必填：否</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>关联职位 ID 列表（与 update_option.need_update_related_job 配合使用；该字段已失效，请勿使用）</para>
    /// <para>必填：否</para>
    /// </summary>
