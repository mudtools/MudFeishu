...
public class Job
{
    ...
    public JobHighlight[]? HighlightList { get; set; }
    ...
    /// <summary>
    /// <para>创建人 ID，若为空则为系统或其他对接系统创建</para>
    /// <para>必填：否</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>创建时间（请使用 create_timestamp）</para>
    /// <para>必填：否</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>更新时间（请使用 update_timestamp）</para>
    /// <para>必填：否</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>招聘流程类型：1 社招流程 / 2 校招流程</para>
    /// <para>必填：否</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>到期日期（请使用 expiry_timestamp）</para>
    /// <para>必填：否</para>
    /// </summary>
    ...
    public TargetMajorInfo[]? TargetMajorList { get; set; }
}
