...
public class GetAnalyticsOverviewResult
{
    /// <summary>
    /// <para>活跃用户数指标</para>
    /// <para>必填：否</para>
    ...
    public AnalyticsMetric? ActiveUsers { get; set; }
    ...
    public AnalyticsMetric? Signups { get; set; }
    ...
    public AnalyticsMetric? PageViews { get; set; }
}
