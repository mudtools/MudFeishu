...
public class UpdateAvailableScopeRequest
{
    /// <summary>
    /// <para>使用权限范围类型</para>
    /// <para>必填：是</para>
    ...
    /// <summary>
    /// <para>部门 ID 列表（仅 ALLOW_PART/DENY_PART 时生效），长度范围 0～1000</para>
    /// <para>必填：否</para>
    ...
    /// <summary>
    /// <para>成员 ID 列表（仅 ALLOW_PART/DENY_PART 时生效），长度范围 0～1000</para>
    /// <para>必填：否</para>
