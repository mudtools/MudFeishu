...
/// <summary>
/// 多维表格记录变更
/// <para>多维表格记录变更事件。被订阅的多维表格记录发生变更时，将会触发此事件。</para>
/// <para>事件类型:drive.file.bitable_record_changed_v1</para>
/// <para>使用时请继承：<see cref="BitableRecordChangedEventHandler"/></para>
/// <para>文档地址：https://open.feishu.cn/document/docs/bitable-v1/events/bitable_record_changed</para>
/// </summary>
[GenerateEventHandler(EventType = FeishuEventTypes.BitableRecordChanged, HandlerNamespace = Consts.HandlerNamespace,
              InheritedFrom = Consts.InheritedFrom, HeaderType = nameof(FeishuEventHeader))]
public class BitableRecordChangedResult : IEventResult
{
    /// <summary>
