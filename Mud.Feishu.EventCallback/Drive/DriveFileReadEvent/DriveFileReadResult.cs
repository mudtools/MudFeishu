...
/// <para>事件类型:drive.file.read_v1</para>
...
/// </summary>
[GenerateEventHandler(EventType = FeishuEventTypes.DriveFileRead, HandlerNamespace = Consts.HandlerNamespace,
              InheritedFrom = Consts.InheritedFrom, HeaderType = nameof(DriveFileEventHeader))]
[HttpJsonSerializable(SerializerClassName = "Drive")]
public class DriveFileReadResult : IEventResult
{
    /// <summary>
