...
/// <para>事件类型:drive.file.trashed_v1</para>
/// <para>使用时请继承：<see cref="DriveFileTrashedEventHandler"/></para>
/// <para>文档地址：https://open.feishu.cn/document/server-docs/docs/drive-v1/event/list/delete-file-to-trash-can</para>
/// </summary>
[GenerateEventHandler(EventType = FeishuEventTypes.DriveFileTrashed, HandlerNamespace = Consts.HandlerNamespace,
              InheritedFrom = Consts.InheritedFrom, HeaderType = nameof(DriveFileEventHeader))]
public class DriveFileTrashedResult : IEventResult
{
    /// <summary>
