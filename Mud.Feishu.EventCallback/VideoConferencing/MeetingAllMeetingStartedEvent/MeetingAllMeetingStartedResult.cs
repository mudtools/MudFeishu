...
/// <summary>
/// 企业会议开始
/// <para>发生在会议开始时，包含企业内所有会议开始事件。</para>
/// <para>事件类型:vc.meeting.all_meeting_started_v1</para>
/// <para>使用时请继承：<see cref="MeetingAllMeetingStartedEventHandler"/></para>
/// <para>文档地址：https://open.feishu.cn/document/server-docs/vc-v1/meeting/events/all_meeting_started</para>
/// </summary>
[GenerateEventHandler(EventType = FeishuEventTypes.MeetingAllMeetingStarted, HandlerNamespace = Consts.HandlerNamespace,
...
public class MeetingAllMeetingStartedResult : IEventResult
{
    /// <summary>
    /// <para>会议数据</para>
    /// <para>必填：否</para>
