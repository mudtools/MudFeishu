...
/// <summary>
/// 加入会议
/// <para>发生在有人加入会议时【仅通过Open API预约的会议会产生此类事件】</para>
/// <para>事件类型:vc.meeting.join_meeting_v1</para>
/// <para>使用时请继承：<see cref="MeetingJoinMeetingEventHandler"/></para>
/// <para>文档地址：https://open.feishu.cn/document/server-docs/vc-v1/meeting/events/join_meeting</para>
/// </summary>
[GenerateEventHandler(EventType = FeishuEventTypes.MeetingJoinMeeting, HandlerNamespace = Consts.HandlerNamespace,
...
public class MeetingJoinMeetingResult : IEventResult
{
    /// <summary>
    /// <para>会议数据</para>
    /// <para>必填：否</para>
