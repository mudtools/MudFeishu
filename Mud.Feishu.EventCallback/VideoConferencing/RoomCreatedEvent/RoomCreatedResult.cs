...
/// <summary>
/// 会议室创建
/// <para>发生在创建会议室时【仅通过Open API预约的会议会产生此类事件】</para>
/// <para>事件类型:vc.room.created_v1</para>
/// <para>使用时请继承：<see cref="RoomCreatedEventHandler"/></para>
/// <para>文档地址：https://open.feishu.cn/document/server-docs/vc-v1/room/events/created</para>
/// </summary>
[GenerateEventHandler(EventType = FeishuEventTypes.RoomCreatedEvent, HandlerNamespace = Consts.HandlerNamespace,
...
public class RoomCreatedResult : IEventResult
{
    /// <summary>
    /// <para>会议室信息</para>
    /// <para>必填：否</para>
