...
/// <summary>
/// 会议室删除
/// <para>发生在删除会议室时【仅通过Open API预约的会议会产生此类事件】</para>
/// <para>事件类型:vc.room.deleted_v1</para>
/// <para>使用时请继承：<see cref="RoomDeletedEventHandler"/></para>
...
public class RoomDeletedResult : IEventResult
{
    ...
    public RoomEventId? Room { get; set; }
