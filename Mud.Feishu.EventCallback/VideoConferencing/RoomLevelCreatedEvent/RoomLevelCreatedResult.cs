...
/// <summary>
/// 会议室层级创建
/// <para>发生在创建会议室层级时【仅通过Open API预约的会议会产生此类事件】</para>
/// <para>事件类型:vc.room_level.created_v1</para>
/// <para>使用时请继承：<see cref="RoomLevelCreatedEventHandler"/></para>
/// <para>文档地址：https://open.feishu.cn/document/server-docs/vc-v1/room_level/events/created</para>
/// </summary>
[GenerateEventHandler(EventType = FeishuEventTypes.RoomLevelCreatedEvent, HandlerNamespace = Consts.HandlerNamespace,
...
public class RoomLevelCreatedResult : IEventResult
{
    /// <summary>
    /// <para>层级信息</para>
    /// <para>必填：否</para>
