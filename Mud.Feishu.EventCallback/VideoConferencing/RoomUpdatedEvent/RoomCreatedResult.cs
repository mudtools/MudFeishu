...
/// <summary>
/// 会议室更新
/// <para>发生在更新会议室时【仅通过Open API预约的会议会产生此类事件】</para>
/// <para>事件类型:vc.room.updated_v1</para>
/// <para>使用时请继承：<see cref="RoomUpdatedEventHandler"/></para>
/// <para>文档地址：https://open.feishu.cn/document/server-docs/vc-v1/room/events/updated</para>
/// </summary>
[GenerateEventHandler(EventType = FeishuEventTypes.RoomUpdatedEvent, HandlerNamespace = Consts.HandlerNamespace,
...
public class RoomUpdatedResult : IEventResult
{
    /// <summary>
    /// <para>会议室信息</para>
    /// <para>必填：否</para>
