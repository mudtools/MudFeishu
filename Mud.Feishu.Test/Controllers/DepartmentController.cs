...
public class DepartmentController : ControllerBase
{
        ...
        [FromQuery] string? parentDepartmentId = null)
    {
        try
        {
            var result = await _departmentApi.GetDepartmentsAsync(pageSize, pageToken, departmentIdType, parentDepartmentId);
            return Ok(result);
        }
        catch (Exception ex)
        {
        ...
        [FromQuery] string departmentIdType = "department_id")
    {
        try
        {
            var result = await _departmentApi.GetDepartmentChildrenAsync(departmentId, pageSize, pageToken, departmentIdType);
            return Ok(result);
        }
        catch (Exception ex)
        {
