...
namespace Mud.Feishu.Webbook.Demo.Models;
...
public class WebbookStatus
{
    ...
    public WebbookConfiguration Configuration { get; init; } = null!;
...
/// Webbook配置信息
/// </summary>
public class WebbookConfiguration
{
...
/// Webbook事件测试请求
/// </summary>
public class WebbookTestRequest
{
    public string EventType { get; init; } = string.Empty;
...
public class VerifyConfigurationRequest
{
    ...
    public string RoutePrefix { get; init; } = "feishu/webbook";
}

/// <summary>
/// Webbook测试结果
/// </summary>
public class WebbookTestResult
{
