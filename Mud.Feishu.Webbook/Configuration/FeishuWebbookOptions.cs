...
namespace Mud.Feishu.Webbook.Configuration;

/// <summary>
/// 飞书 Webbook 事件处理配置
/// </summary>
public class FeishuWebbookOptions
{
    /// <summary>
    ...
    /// Webbook 路由前缀
    /// </summary>
    public string RoutePrefix { get; set; } = "feishu/webbook";
...
/// 飞书 Webbook 请求模型
/// </summary>
public class FeishuWebbookRequest
{
    /// <summary>
    /// 加密的事件数据
    /// </summary>
