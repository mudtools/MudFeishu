...
/// <summary>
/// 飞书Webbook服务建造者，用于简化服务注册配置
/// </summary>
public class FeishuWebbookServiceBuilder
{
    ...
    private Action<FeishuWebbookOptions>? _configureOptions;

    /// <summary>
    /// 构造函数
    /// </summary>
    /// <param name="services">服务集合</param>
    internal FeishuWebbookServiceBuilder(IServiceCollection services)
    {
    ...
    public FeishuWebbookServiceBuilder ConfigureFrom(IConfiguration configuration, string? sectionName = null)
    {
        if (configuration == null)
            throw new ArgumentNullException(nameof(configuration));

        var section = sectionName ?? "FeishuWebbook";
        _services.Configure<FeishuWebbookOptions>(options => configuration.GetSection(section).Bind(options));
        return this;
    }
    ...
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder ConfigureOptions(Action<FeishuWebbookOptions> configureOptions)
    {
    ...
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder EnableControllers()
    {
    ...
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder DisableControllers()
    {
    ...
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder EnableHealthChecks()
    {
    ...
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder DisableHealthChecks()
    {
    ...
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder EnableMetrics()
    {
        _enableMetrics = true;
        return this;
    }
    ...
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder DisableMetrics()
    {
    ...
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder EnableAutoEndpoint()
    {
    ...
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder DisableAutoEndpoint()
    {
    ...
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder AddHandler<THandler>()
    ...
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder AddHandler<THandler>(THandler handlerInstance)
        where THandler : class, IFeishuEventHandler
    {
    ...
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder AddHandler<THandler>(Func<IServiceProvider, THandler> handlerFactory)
        where THandler : class, IFeishuEventHandler
    {
    ...
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuWebbookServiceBuilder Apply(Action<FeishuWebbookServiceBuilder> configureAction)
    {
    ...
    private void RegisterOptions()
    {
        ...
        // 确保基本配置存在
        _services.PostConfigure<FeishuWebbookOptions>(options =>
        {
            // 设置默认值
    ...
    private void RegisterCoreServices()
    {
        ...
        _services.TryAddScoped<IFeishuWebbookService, FeishuWebbookService>();
    }
    ...
    private void RegisterControllerServices()
    {
        ...
        if (actionDescriptorProviderType != null && _services.Any(s => s.ServiceType == actionDescriptorProviderType))
        {
            ...
            if (addControllersMethod != null)
            {
                ...
                {
                    var controllerAssemblyType = Type.GetType("Mud.Feishu.Webbook.Controllers.FeishuWebbookController, Mud.Feishu.Webbook");
