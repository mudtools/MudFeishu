...
/// 使用内存缓存 + 滑动窗口实现事件幂等性
/// </summary>
public class FeishuWebhookEventDeduplicator : IAsyncDisposable
{
    ...
    /// 构造函数
    /// </summary>
    public FeishuWebhookEventDeduplicator(
        ILogger<FeishuWebhookEventDeduplicator> logger,
        ...
        TimeSpan? cleanupInterval = null)
    {
        ...
        _logger.LogInformation("飞书 Webhook 事件去重服务初始化完成，缓存过期时间: {Expiration}, 清理间隔: {CleanupInterval}",
    ...
    /// <returns>如果事件已处理返回 true，否则返回 false 并记录</returns>
