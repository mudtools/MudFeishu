...
public class FeishuServiceBuilder
{
    ...
    private static Dictionary<FeishuModule, IFeishuModuleRegistrar> InitializeRegistrars()
    {
        return new Dictionary<FeishuModule, IFeishuModuleRegistrar>
        {
            ...
            [FeishuModule.Hire] = new FeishuModuleRegistrar(FeishuModule.Hire, s => s.AddHireWebApiHttpClient()),
    ...
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuServiceBuilder AddMailApi() => AddModule(FeishuModule.Mail);
    ...
    /// </summary>
    /// <returns></returns>
    public FeishuServiceBuilder AddHelpDeskApi() => AddModule(FeishuModule.HelpDesk);
    ...
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuServiceBuilder AddHireApi() => AddModule(FeishuModule.Hire);

    /// <summary>
    /// 添加飞书关联组织（信任方）API 服务
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuServiceBuilder AddTrustPartyApi() => AddModule(FeishuModule.TrustParty);

    /// <summary>
    /// 添加飞书智能门禁 API 服务
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuServiceBuilder AddAcsApi() => AddModule(FeishuModule.Acs);

    /// <summary>
    /// 添加飞书词典 API 服务
    /// </summary>
    /// <returns>建造者实例，支持链式调用</returns>
    public FeishuServiceBuilder AddLingoApi() => AddModule(FeishuModule.Lingo);
