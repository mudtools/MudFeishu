...
public interface IFeishuAuthenticationApi
{
    ...
    Task<OAuthCredentialsResult> GetOAuthenAccessToken([Body] OAuthTokenRequest credentials);
    ...
    /// <returns></returns>
    [Post("https://open.feishu.cn/open-apis/authen/v2/oauth/token")]
    Task<OAuthCredentialsResult> GetOAuthenRefreshAccessToken([Body] OAuthRefreshTokenRequest credentials);
    ...
    Task<AuthorizeResult> GetAuthorize(
