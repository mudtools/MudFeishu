...
/// </summary>
[HttpClientApi(TokenManage = nameof(IFeishuAppManager), RegistryGroupName = "Drive", InheritedFrom = nameof(FeishuV1Comments))]
[Token("UserAccessToken", Name = Consts.Authorization)]
public interface IFeishuUserV1Comments : IFeishuV1Comments, ICurrentUserId
{
}