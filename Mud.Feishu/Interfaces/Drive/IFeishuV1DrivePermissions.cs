...
public interface IFeishuV1DrivePermissions : IFeishuAppContextSwitcher
{
    ...
    /// </list>
    /// </param>  
    /// <param name="updateDrivePermissionsRequest">更新云文档权限设置的请求体。</param>
    /// <param name="cancellationToken"><see cref="CancellationToken"/>取消操作令牌对象。</param>
    /// <returns></returns>
    ...
    /// <para><see href="https://open.feishu.cn/document/server-docs/docs/permission/permission-public/get-2">接口文档</see></para>
    /// </summary>
    /// <param name="token">
    /// <para>路径参数</para>
    /// <para>必填：是</para>
    ...
    /// <para><see href="https://open.feishu.cn/document/server-docs/docs/permission/permission-public/permission-public-password/create">接口文档</see></para>
    /// </summary>
    /// <param name="token">
    /// <para>路径参数</para>
    /// <para>必填：是</para>
