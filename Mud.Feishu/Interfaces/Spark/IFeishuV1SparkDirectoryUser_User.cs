...
/// <summary>
/// 飞书妙搭（Spark）用户目录 SDK 是一组服务端 OpenAPI 的封装，以用户身份在飞书妙搭与飞书开放平台之间转换用户 ID。
...
public interface IFeishuUserV1SparkDirectoryUser : IFeishuV1SparkDirectoryUser, ICurrentUserId
{
}
