...
/// </summary>
[HttpClientApi(TokenManage = nameof(IFeishuAppManager), RegistryGroupName = "Spreadsheets", InheritedFrom = nameof(FeishuV3SpreadsheetRange))]
[Token("UserAccessToken", Name = Consts.Authorization)]
public interface IFeishuUserV3SpreadsheetRange : IFeishuV3SpreadsheetRange, ICurrentUserId
{
}
