...
/// <summary>
/// 飞书可搜可见规则 SDK（用户令牌）：以 user_access_token 身份调用，仅支持自建应用，调用者需具备关联组织管理员权限。
...
public interface IFeishuUserV1DirectoryCollaborationRule : IFeishuV1DirectoryCollaborationRule, ICurrentUserId
{
}
