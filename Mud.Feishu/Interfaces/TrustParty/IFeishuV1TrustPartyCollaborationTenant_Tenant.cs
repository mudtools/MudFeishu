...
/// <summary>
/// 飞书关联组织（trust_party/v1）SDK（租户令牌）：以 tenant_access_token 身份调用，可见性按应用互通界面对应用设置的可见性规则校验。
...
public interface IFeishuTenantV1TrustPartyCollaborationTenant : IFeishuV1TrustPartyCollaborationTenant
{
}
