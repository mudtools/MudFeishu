...
public interface IFeishuV1VideoConferencingExports : IFeishuAppContextSwitcher
{
    ...
    /// <summary>
    /// 导出参会人明细
    /// <para>导出某个会议的参会人详情列表，具体权限要求请参考<see href="https://open.feishu.cn/document/server-docs/vc-v1/export/export-overview">资源介绍</see>。</para>
    /// <para><see href="https://open.feishu.cn/document/server-docs/vc-v1/export/participant_list">接口文档</see></para>
    /// </summary> 
    /// <param name="user_id_type">
    /// <para>用户 ID 类型</para>
    /// <para>示例值：open_id</para>
    ...
    /// <para>默认值：open_id</para>
    /// </param>
    /// <param name="participantListExportRequest">导出会议参与人明细请求体</param>
    /// <param name="cancellationToken"><see cref="CancellationToken"/>取消操作令牌对象。</param>
    [Post("/open-apis/vc/v1/exports/participant_list")]
    Task<FeishuApiResult<MeetingExportResult>?> ParticipantListExportAsync(
      [Body] ParticipantListExportRequest participantListExportRequest,
      [Query] string? user_id_type = Consts.User_Id_Type,
      CancellationToken cancellationToken = default);
    ...
    /// <para>默认值：open_id</para>
    /// </param>
    /// <param name="participantQualityListExportRequest">导出参会人会议质量数据请求体</param>
    /// <param name="cancellationToken"><see cref="CancellationToken"/>取消操作令牌对象。</param>
    ...
    Task<FeishuApiResult<MeetingExportResult>?> ParticipantQualityListExportAsync(
        [Body] ParticipantQualityListExportRequest participantQualityListExportRequest,
        [Query] string? user_id_type = Consts.User_Id_Type,
        CancellationToken cancellationToken = default);
    ...
    /// <para>默认值：open_id</para>
    /// </param>
    /// <param name="resourceReservationListExportRequest">导出会议室预定数据请求体</param>
    /// <param name="cancellationToken"><see cref="CancellationToken"/>取消操作令牌对象。</param>
    ...
    Task<FeishuApiResult<MeetingExportResult>?> ResourceReservationListExportAsync(
      [Body] ResourceReservationListExportRequest resourceReservationListExportRequest,
      [Query] string? user_id_type = Consts.User_Id_Type,
      CancellationToken cancellationToken = default);
