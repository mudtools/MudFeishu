...
| 功能模块 | Mud.Feishu (HTTP API) | Mud.Feishu.WebSocket |
|---------|----------------------|-------------------|
| **🏢 组织架构** | ✅ 用户/部门/员工管理<br>✅ 职级/职位/角色管理<br>✅ V1/V3 双版本支持 | ✅ 用户生命周期事件<br>✅ 组织架构变更事件<br>✅ 实时状态同步 |
| **📱 消息服务** | ✅ 文本/图片/文件消息<br>✅ 批量消息发送<br>✅ 群聊管理 | ✅ 消息接收事件<br>✅ 发送状态通知<br>✅ 阅读状态事件 |
| **🔄 事件处理** | ➖ (非实时) | ✅ 实时事件订阅<br>✅ 多处理器支持<br>✅ 自定义事件类型 |
| **🫀 连接管理** | HTTP 连接池管理 | ✅ WebSocket 连接管理<br>✅ 自动重连机制<br>✅ 心跳监控 |
| **📈 监控支持** | API 调用统计 | ✅ 连接状态监控<br>✅ 性能指标统计<br>✅ 健康检查 |
