...
提供以租户身份管理飞书多维表格仪表盘的能力。仪表盘 block，仪表盘与数据看板类似，可以从不同的维度统计对多维表格中的数据进行统计。仪表盘的唯一标识为 block_id，以 blk 开头，可通过多维表格 URL 获取 block_id。支持复制仪表盘和列出仪表盘等操作。
...
| --------------------------- | ------------ | -------- | --------- |
| CopyDashboardAsync          | 复制仪表盘   | 租户令牌 | POST      |
| GetDashboardPageListAsync   | 列出仪表盘   | 租户令牌 | GET       |
